    ...
    if (!error) {
        ...
        if ([status isEqualToString:@"OK"]) {
			...
			if ([status isEqualToString:@"ERROR"]) {
                ...
                NSString *errorMessage = result[@"error"][@"errorMessage"];
                
				error = [NSError errorWithDomain:kDPAPIErrorDomain code:code userInfo:@{NSLocalizedDescriptionKey:errorMessage}];
